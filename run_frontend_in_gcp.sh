...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="magdaza1"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="magdaza" # without the @post.bgu.ac.il or @gmail.com part
...
# 3. Create the instance. Change to a larger instance (larger than e2-medium) as needed.
gcloud compute instances create $INSTANCE_NAME \
  ...
  --tags=http-server --boot-disk-size=30GB

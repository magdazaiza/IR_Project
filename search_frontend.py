...
try:
   ...
   os.system('mkdir body')
   os.system('mkdir anchor')
   os.system('mkdir title')
   os.system('gsutil -m cp gs://208220756/postings_gcp/* "/home/magdaza/title"') #title
   os.system('gsutil -m cp gs://208220756/postings_gcp_body/* "/home/magdaza/body"') #body
   os.system('gsutil -m cp gs://208220756/postings_gcp_anchor/* "/home/magdaza/anchor"') #anchor
   os.system('gsutil -m cp gs://208220756/Doc_Len "/home/magdaza/DL"') #DL
   os.system('gsutil -m cp gs://208220756/Titles "/home/magdaza/titles"') #Titles
   os.system('gsutil -m cp gs://208220756/Views "/home/magdaza/views"')#Views
name = 'DL'
with open(Path('/home/magdaza') / f'{name}', 'rb') as f:
...
name = 'views'
with open(Path('/home/magdaza') / f'{name}', 'rb') as f:
             Views = pickle.loads(f.read())


class MyFlaskApp(Flask):
    index_body = InvertedIndex.read_index("/home/magdaza/body","index_body")
    index_title = InvertedIndex.read_index("/home/magdaza/title","index_title")
    index_anchor = InvertedIndex.read_index("/home/magdaza/anchor","index_anchor")
